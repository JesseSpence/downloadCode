  ...
  <div class="CardView">
    ...
    <div id="tv-body >">
        <div id="tv">
              ...
              <select class="form-select" id="track" onchange="filter2()" style="width: 200px;" aria-label="Default select example">
              ...
              <select class="form-select" id="nation" onchange="filter3()" style="width: 200px;" aria-label="Default select example">
                <option selected value="all">Price</option>
                <option value="">Ascending</option>
                <option value="">Descending</option>
              </select>
              
              <select class="form-select" id="class" onchange="filter1()" style="width: 200px;" aria-label="Default select example">
    ...
    <button class="btn p-3 btn-warning" @click="sortPrices">Price</button>
      
<div class="flex mt-5">
    <div @click="openCard" id="body" v-for="product of product" :key="product.id">
...
.controls-1::before {
     border-radius: 50%;
      box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2), 8px 4px 3px 1px rgba(0, 0, 0, 0.2),
        6px 2px 3px 1px rgba(0, 0, 0, 0.2);
      content: " ";
      position: absolute;
      display: block;
      background: grey;
...
.controls-3:hover::after,.controls-3:hover::before{
